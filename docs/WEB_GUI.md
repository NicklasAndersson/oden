...
| **TAK → text** | Första steget för TAK: gör om CoT (XML) till text för stegen efter. Inställningar per gren: 8S → 7S, SCRIM, övriga markörer (observation eller hoppa över), `%%`-blocket. Syns i Flöde som *Omvandlad* |
