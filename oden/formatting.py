...
def create_message_filename(dt: datetime.datetime, source_name: str | None, source_number: str | None) -> str:
...
def get_message_filepath(
    group_title: str, dt: datetime.datetime, source_name: str | None, source_number: str | None
) -> str:
