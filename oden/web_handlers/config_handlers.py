...
async def config_handler(request: web.Request) -> web.Response:
    ...
    config_data = {
        ...
        "diagnostic_mode": _as_bool(config.get("diagnostic_mode", True), True),
...
async def config_save_handler(request: web.Request) -> web.Response:
    ...
    form_updates = {
        ...
        "group_split_enabled": data.get("group_split_enabled", True),
        ...
        "diagnostic_mode": data.get("diagnostic_mode", True),
