    ...
    return web.json_response(
        {
            ...
            "rx_total": getattr(bridge, "rx_total", 0),
            "rx_filtered": getattr(bridge, "rx_filtered", 0),
            "last_tx_at": (bridge.last_tx_at.isoformat() if bridge and bridge.last_tx_at else None),
            "last_rx_at": (bridge.last_rx_at.isoformat() if bridge and getattr(bridge, "last_rx_at", None) else None),
